...
module.exports = function (message, client, prefix, needle) {
  ...
  if (message.content == prefix + 'passwordgen') {

    needle.get(`https://api.c99.nl/passwordgenerator?key=${process.env.C99_API_KEY}&length=32&include=numbers,letters,chars&customlist=abcdefghijklmnopqrstuvwxyz0123456789`, {
    }, (e, r) => {
      ...
      message.channel.send('*Generated Password sent in your DMs...*');
      const embed = new MessageEmbed();
      embed.setDescription(`\`\`\`${r.body}\`\`\``);
